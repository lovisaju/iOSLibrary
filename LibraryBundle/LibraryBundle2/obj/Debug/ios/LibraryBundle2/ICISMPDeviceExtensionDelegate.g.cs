...
namespace LibraryBundle2 {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidReceiveData", Selector = "didReceiveData:fromICISMPDevice:", ParameterType = new Type [] { typeof (NSData), typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillReceiveData", Selector = "willReceiveData:", ParameterType = new Type [] { typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillSendData", Selector = "willSendData:", ParameterType = new Type [] { typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidSendData", Selector = "didSendData:withNumberOfBytesSent:fromICISMPDevice:", ParameterType = new Type [] { typeof (NSData), typeof (uint), typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false, false, false })]
	public interface IICISMPDeviceExtensionDelegate : INativeObject, IDisposable, 
		LibraryBundle2.IICISMPDeviceDelegate
