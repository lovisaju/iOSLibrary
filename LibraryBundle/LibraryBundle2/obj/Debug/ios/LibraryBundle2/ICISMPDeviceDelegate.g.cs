...
namespace LibraryBundle2 {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AccessoryDidConnect", Selector = "accessoryDidConnect:", ParameterType = new Type [] { typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AccessoryDidDisconnect", Selector = "accessoryDidDisconnect:", ParameterType = new Type [] { typeof (LibraryBundle2.ICISMPDevice) }, ParameterByRef = new bool [] { false })]
