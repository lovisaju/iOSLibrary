...
namespace LibraryBundle2 {
	public unsafe static partial class ICAdministration_StandAlone  {
		...
		[CompilerGenerated]
		public static void DoTransaction (this ICAdministration This, ICTransactionRequest request, NSData extendedData, nuint appNum)
		{
			if (extendedData == null)
				throw new ArgumentNullException ("extendedData");
			global::ApiDefinition.Messaging.void_objc_msgSend_ICTransactionRequest_IntPtr_nuint (This.Handle, Selector.GetHandle ("doTransaction:withData:andApplicationNumber:"), request, extendedData.Handle, appNum);
		}
		
		[Export ("getDoTransactionTimeout")]
		[CompilerGenerated]
		public static nuint DoTransactionTimeout (this ICAdministration This)
		{
		...
		[CompilerGenerated]
		public static void SetDoTransactionTimeout (this ICAdministration This, nuint timeout)
		{
