...
namespace LibraryBundle {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "NotifyConnection", Selector = "notifyConnection:", ParameterType = new Type [] { typeof (LibraryBundle.ICPclService) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "NotifyDisconnection", Selector = "notifyDisconnection:", ParameterType = new Type [] { typeof (LibraryBundle.ICPclService) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldDoSignatureCapture", Selector = "shouldDoSignatureCapture:", ParameterType = new Type [] { typeof (LibraryBundle.ICSignatureData) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "TransactionDidEndWithTimeoutFlag", Selector = "transactionDidEndWithTimeoutFlag:result:andData:", ParameterType = new Type [] { typeof (bool), typeof (LibraryBundle.ICTransactionReply), typeof (NSData) }, ParameterByRef = new bool [] { false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldFeedPaperWithLines", Selector = "shouldFeedPaperWithLines:", ParameterType = new Type [] { typeof (uint) }, ParameterByRef = new bool [] { false })]
	...
	public static partial class ICPclServiceDelegate_Extensions {
		...
		[CompilerGenerated]
		public static void ShouldFeedPaperWithLines (this IICPclServiceDelegate This, uint lines)
		{
			global::ApiDefinition.Messaging.void_objc_msgSend_UInt32 (This.Handle, Selector.GetHandle ("shouldFeedPaperWithLines:"), lines);
		}
...
namespace LibraryBundle {
	...
	public unsafe partial class ICPclServiceDelegate : NSObject, IICPclServiceDelegate {
		...
		[CompilerGenerated]
		public virtual void ShouldFeedPaperWithLines (uint lines)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
